...
<div class="modal" id="pickerModal">
  <div class="card2">
    ...
    <div class="small" style="margin-top:8px">Favorites <span class="subhead">(Short-tap→Apply) (Long-press→Save)</span></div>
